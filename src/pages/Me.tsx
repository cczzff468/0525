...
const ROWS = [
  ...
  { label: '记忆匣子', bg: '#af52de', d: 'M9 3.5h6M7.5 5.5h9a1 1 0 0 1 1 1V19a1.5 1.5 0 0 1-1.5 1.5H8A1.5 1.5 0 0 1 6.5 19V6.5a1 1 0 0 1 1-1ZM12 10c-1.8 0-3 1-3 2.4 0 2.1 3 2.1 3 3.6m0-6c1.8 0 3 1 3 2.4 0 2.1-3 2.1-3 3.6m0-6v9' },
      ...
      <div className="page-body">
        ...
        <div className="list-group">
          {ROWS.map((r) => (
            ...
            >
              <div className="row-icon row-icon-grad" style={{ background: r.bg }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path d={r.d} stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
        ...
        <div className="list-group">
          <button className="row" onClick={onOpenSettings}>
            <div className="row-icon row-icon-grad" style={{ background: 'linear-gradient(135deg, #8e8e93, #aeaeb2)' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="8" stroke="#fff" strokeWidth="1.8" />
                <path d="M12 8v.5M12 11v5" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" />
              </svg>
            </div>
            <div className="row-main">
